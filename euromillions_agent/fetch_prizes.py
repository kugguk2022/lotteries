...
def main():
    ap = argparse.ArgumentParser(description="Fetch EuroMillions prize breakdown and save as prizes.json")
    ...
    print(f"Wrote {args.out} with {len(data)} keys from {meta['source_url']} ({meta.get('draw_date')})")
